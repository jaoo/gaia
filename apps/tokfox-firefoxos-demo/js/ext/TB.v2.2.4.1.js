...
(function(window) {
  ...
  OT.properties = {
    ...
    // The dymanic config file location when runnint on top of running FxOS.
    configURL: '/js/ext/dynamic_config.v2.2.4.1.min.js',
    // The css file location when running on top of running FxOS.
    cssURL: '/style/opentok/ot.v2.2.4.1.min.css'
  };
